...
sumoCmd = [
    sumoBinary,
    "-c",
    r"F:/大学/MTFwiki\SUMO-Q_learning\SUMO-RL-ramp-control/Q-learning-control/test1.sumo.cfg",
    "--tripinfo-output",
    r"F:\software two\sumo-1.8.0/file1/tripinfo2.xml",
...
def output_lane_speed():  # 输出01234道路的平均速度
    ...
    car_simple_speed.to_csv(
        r"F:/大学/MTFwiki\SUMO-Q_learning\SUMO-RL-ramp-control/Q-learning-control/csv/"
        + T1
        + ".csv"
    )
