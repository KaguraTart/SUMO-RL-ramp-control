...
sumoCmd = [
    sumoBinary,
    "-c",
    r"F:\software two\sumo-1.8.0/file3/beihong2.sumo.cfg",
    "--tripinfo-output",
    r"F:\software two\sumo-1.8.0/file3/tripinfo2.xml",
...
def rl():
    ...
    for episode in range(MAX_EPISODES):
        ...
        q_table_train.to_excel(
            r"F:\software two\sumo-1.8.0/file3/doc/"
            + "qtable"
            + str(episode)
            + ".xlsx",
            index=False,
...
def traci_control_env_update(step_time, q_table):
    ...
    for step in range(0, step_time):
        ...
        H_01_meanspeed = (
            traci.lane.getLastStepMeanSpeed("H_0") * 3.6
            + traci.lane.getLastStepMeanSpeed("H_1") * 3.6
        ) / 2
        ...
        traci.trafficlight.setRedYellowGreenState(
            traci.trafficlight.getIDList()[0], choose_action(step, q_table) + "G"
