...
sumoCmd = [
    sumoBinary,
    "-c",
    r"F:\software two\sumo-1.8.0/file2/beihong1.sumo.cfg",
    "--tripinfo-output",
    r"F:\software two\sumo-1.8.0/file2/tripinfo2.xml",
...
def rl():
    ...
    for episode in range(MAX_EPISODES):
        ...
        q_table_train.to_excel(
            r"F:\software two\sumo-1.8.0/file2/doc/"
            + "qtable"
            + str(episode)
            + ".xlsx",
            index=False,
...
def output_lane_speed():  # 输出01234道路的平均速度
    ...
    plt.show()
    fig.savefig(r"F:\software two\sumo-1.8.0/file2/img1/" + "car_speed_lane_None.png")
    ...
    plt.ylabel("speed km/h", fontsize=30)
    plt.show()
    fig.savefig(r"F:\software two\sumo-1.8.0/file2/img1/" + "car_mean_speed12_None.png")


def output_lane_OOC():  # 画图
    get_OOC = {"H_0": get_OOC0_list, "H_1": get_OOC1_list, "H_2": get_OOC2_list}
    ...
    plt.show()
    fig.savefig(r"F:\software two\sumo-1.8.0/file2/img1/" + "OCC_None.png")
    ...
    plt.ylabel("%", fontsize=30)
    plt.show()
    fig.savefig(r"F:\software two\sumo-1.8.0/file2/img1/" + "OCCmean_None.png")
