...
def output_lane_speed():   #输出01234道路的平均速度
    ...
    plt.show()
    fig.savefig(r'F:\software two\sumo-1.8.0/file3/img1/'   + 'car_speed_lane_RL.png')
    ...
    plt.ylabel('speed km/h',fontsize = 30)
    plt.show()
    fig.savefig(r'F:\software two\sumo-1.8.0/file3/img1/'   + 'car_mean_speed12_RL.png')
...
def output_lane_OOC(): #画图
    ...
    plt.show()
    fig.savefig(r'F:\software two\sumo-1.8.0/file3/img1/'   + 'OCC_RL.png')
    ...
    plt.ylabel('%',fontsize = 30)
    plt.show()
    fig.savefig(r'F:\software two\sumo-1.8.0/file3/img1/'   + 'OCCmean_RL.png')
